...
public class TensToStringTest {
    private String inpVal;
    private String expVal;
    
    public TensToStringTest(String inpVal, String expVal) {
        this.inpVal = inpVal;
        this.expVal = expVal;
    }
    ...
    public static Collection data() throws IOException {
        URL url = UnitsToStringTest.class.getResource("/testdata/TensToString.tc");
    ...
    public static void setUpClass() {
        System.out.println("- Chuc nang chuyen so hang CHUC");
    }
    ...
    public void testUnitsToString() {
        ...
        String result = NumToSpeech.tensToString(source);
