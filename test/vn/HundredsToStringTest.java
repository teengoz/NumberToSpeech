...
public class HundredsToStringTest {
    private String inpVal;
    private String expVal;
    
    public HundredsToStringTest(String inpVal, String expVal) {
        this.inpVal = inpVal;
        this.expVal = expVal;
    }
    ...
    public static void setUpClass() {
        System.out.println("- Chuc nang chuyen so hang TRAM");
    }
    ...
    public void testUnitsToString() {
        ...
        String result = NumToSpeech.hundredsToString(source);
